            ...
            <div class="wrapper style1">
                ...
                <div class="container">
                    ...
                    <article id="main" class="special">
                        <form action="<?php echo base_url() . 'c_master/upd_article'; ?>" method="post">
                            <label>Story ID</label>
                            <input type="text" name="id_artikel" value="<?php echo $story->id_artikel; ?>" readonly="TRUE"/>
                            <label>Story Title</label>
                            <input type="text" name="judul" value="<?php echo $story->judul; ?>" autofocus/>
                            <label>Category</label>
                            <select name="kategori" class="form-control">
                                <option value="<?php echo $story->id_cat; ?>"><?php echo $story->nm_cat; ?></option>
                                <?php foreach ($category as $cat) { ?>
                            ...
                            <textarea id="editor1" name="editor1"><?php echo $story->isi; ?></textarea>
                            <br>
                            <button class="btn btn-primary form-control" type="submit">Update and Publish the Story</button>
                        </form>
                    </article>
                </div>
            </div>
